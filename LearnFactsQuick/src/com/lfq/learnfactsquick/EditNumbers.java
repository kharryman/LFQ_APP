...
public class EditNumbers extends Activity {
	...
	public void loadButtons() {
		...
		do_logout.setBackgroundResource(sharedPref.getInt("BG Button",
				R.drawable.button));
		do_begin_update_numbers.setBackgroundResource(sharedPref.getInt(
				"BG Button", R.drawable.button));
		do_begin_insert_numbers.setBackgroundResource(sharedPref.getInt(
				"BG Button", R.drawable.button));
		do_update_numbers.setBackgroundResource(sharedPref.getInt("BG Button",
				R.drawable.button));
		do_delete_numbers.setBackgroundResource(sharedPref.getInt("BG Button",
				R.drawable.button));
		do_insert_numbers.setBackgroundResource(sharedPref.getInt("BG Button",
				R.drawable.button));
		get_entries.setBackgroundResource(sharedPref.getInt("BG Button",
				R.drawable.button));
	}
	...
	public void setListeners() {
		...
		get_entries.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Cursor c_get = MainLfqActivity.getNumbersDb().rawQuery("SELECT * FROM " + numbers_table
						+ " ORDER BY " + user_numbers_table.Type, null);
		...
		do_begin_update_numbers.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Cursor c_get1 = MainLfqActivity.getNumbersDb().rawQuery("SELECT * FROM "
						+ numbers_table + " WHERE _id=" + sav_id, null);
				String[] mnespl = null;
				String[] mne1spl = null;
				if (c_get1.moveToFirst()) {
					mnespl = c_get1.getString(c_get1.getColumnIndex(user_numbers_table.NumWors))
							.split(">>>");
					...
					results.setText("BEGIN UPDATE FOR "
							+ c_get1.getString(c_get1.getColumnIndex(user_numbers_table.Number))
							+ ".");
				}
			}
		...
		do_update_numbers.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				cv.put(user_numbers_table.NumInf, input_number_info.getText().toString());
				text = "";
				for (int i = 0; i < num_entries; i++) {
				...
				MainLfqActivity.getNumbersDb().update(numbers_table, cv, "_id=" + sav_id, null);
				sql = "UPDATE " + Helpers.db_prefix + "newwords." + numbers_table
						+ " SET " + user_numbers_table.Number + "='" + input_number.getText().toString()
						+ ", " + user_numbers_table.NumInf + "='" + input_number_info.getText().toString()
						+ "', " + user_numbers_table.NumWors + "='" + text + "' WHERE ID='" + sav_id + "'";
		...
		do_insert_numbers.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				cv.put(user_numbers_table.NumWors, text);
				MainLfqActivity.getNumbersDb().insert(numbers_table, null, cv);
				sql = "INSERT INTO " + Helpers.db_prefix + "newwords." + numbers_table
						+ "(" + user_numbers_table.Number + "," + user_numbers_table.NumInf + "," + user_numbers_table.NumWors + ") VALUES('"
						+ input_number.getText().toString() + "','"
		...
		do_delete_numbers.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Cursor c_get1 = MainLfqActivity.getNumbersDb().rawQuery("SELECT * FROM "
						+ numbers_table + " WHERE _id=" + sav_id, null);
				if (c_get1.moveToFirst()) {
					text = c_get1.getString(c_get1.getColumnIndex(user_numbers_table.Number));
				}
				MainLfqActivity.getNumbersDb().execSQL("DELETE FROM " + numbers_table + " WHERE _id="
						+ sav_id);
